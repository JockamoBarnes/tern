...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: 'var(--teal)', borderTop: '1px solid rgba(21,234,173,0.08)' }}>
      <div
        className="mx-auto px-6 md:px-12 py-6"
        style={{ maxWidth: 1200, display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '12px 24px' }}
      >
        {/* Wordmark */}
        <Link href="/" aria-label="Tern home">
          <svg viewBox="0 0 892.5 279.5" style={{ height: 20, width: 'auto', display: 'block', opacity: 0.45 }} aria-hidden="true">
            <defs>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
          <span style={{ fontFamily: 'var(--font-manrope)', fontSize: 12, color: 'rgba(238,247,248,0.3)' }}>
            © {new Date().getFullYear()} Tern App Technologies Co. LLC
          </span>
          <span style={{ color: 'rgba(238,247,248,0.15)' }}>·</span>
          <Link href="/legal/privacy" style={{ fontFamily: 'var(--font-manrope)', fontSize: 12, color: 'rgba(238,247,248,0.3)', textDecoration: 'none' }}>Privacy Policy</Link>
          <span style={{ color: 'rgba(238,247,248,0.15)' }}>·</span>
          <Link href="/legal/terms" style={{ fontFamily: 'var(--font-manrope)', fontSize: 12, color: 'rgba(238,247,248,0.3)', textDecoration: 'none' }}>Terms &amp; Conditions</Link>
        </div>
